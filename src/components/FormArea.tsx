...
export const FormArea = ({ type }: FormAreaProps) => {
  ...
  return (
    <div className="w-full min-h-screen h-full bg-cover bg-center">
      <motion.div
        initial={{
          opacity: 0,
          y: 100,
        ...
        className={`relative flex justify-center top-0 min-h-screen sm:min-h-[calc(100vh-64px)] font-nunito ${
